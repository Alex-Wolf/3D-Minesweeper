...
static var instance:MainController;
...
var spacing:int = 3;
public static var xGrid:int = 4;
public static var yGrid:int = 4;
public static var zGrid:int = 4;
...
function OnGUI(){
 	...
 	//xSlider = GUI.HorizontalSlider(Rect(590,465,180,25),xSlider,0,3);
 	//zSlider = GUI.HorizontalSlider(Rect(590,690,180,25),zSlider,3,0);
 	//ySlider = GUI.VerticalSlider(Rect(565,70,25,170),ySlider,3,0);
	...
	if (winGame){
		...
		if (enteredName){
			...
			gameObject.Find("Database").GetComponent(HSControllerGame).getScores();
			...
			if (databaseScores != ""){
				...
				if (mainTimer < scoreNum){
					...
					if (GUI.Button (Rect (Screen.width / 2 - 65, Screen.height / 2 + 25, 130, 30), "Submit")){
						gameObject.Find("Database").GetComponent(HSControllerGame).postScore(winnerName, mainTimer, "beginner");
						enteredName = true;
					}
				}
				else {
					...
					if (GUI.Button (Rect (Screen.width / 2 - 100, Screen.height / 2  + 40, 200, 25), "Main Menu")){
						...
						winGame = false;
						MainController.instance.loseGameFunction();
					}
				} 
			}
		}
...
public static function fadeOut(){
	fadeDir = 1;
	MainController.instance.fadeOutBool = true;
}
...
function createGUI(){
	...
	topGUIContainer.transform.position.x = Camera.main.transform.position.x + 10;
	topGUIContainer.transform.position.y = Camera.main.transform.position.y + 1.5;
	topGUIContainer.transform.position.z = Camera.main.transform.position.z + 1;
	...
	frontGUIContainer.transform.position.x = Camera.main.transform.position.x + 6;
	frontGUIContainer.transform.position.y = Camera.main.transform.position.y - 6;
	frontGUIContainer.transform.position.z = Camera.main.transform.position.z - 1;
	...
	rightGUIContainer.transform.position.x = Camera.main.transform.position.x + 2;
	rightGUIContainer.transform.position.y = Camera.main.transform.position.y - 13.5;
	rightGUIContainer.transform.position.z = Camera.main.transform.position.z - 3;
...
public static function changeSelection(xIn:int, yIn:int, zIn:int){
	...
	MainController.instance.xSlider = currentX;
	MainController.instance.ySlider = currentY;
	MainController.instance.zSlider = currentZ;
	
	MainController.instance.updateGUI();
...
public static function selectCube(){
	...
	//checks to see if selected cube contains a mine. If it does, lose the game
		...
		if (MainController.instance.firstSelection){
			MainController.instance.firstSelection = false;
		...
		//otherwise if it's not the first selection of the game
			...
			//MainController.instance.mainText.enabled = false;
			//MainController.instance.mainText.SendMessage("showHint", "You Lose!!");
			
			//play mine sound
			if (MainController.instance.soundsOn){
				MainController.instance.transform.audio.PlayOneShot(MainController.instance.mineSound);
			}
				...
				for (y = 0; y < yGrid; y++){
					for (z = 0; z < zGrid; z++){
						if (cubeArray[x,y,z].getHasMine()){
							newCube = Instantiate(MainController.instance.mineCube, cubeArray[x,y,z].transform.position, cubeArray[x,y,z].transform.rotation);
							Destroy(cubeArray[x,y,z].gameObject);
							cubeArray[x,y,z] = newCube;
							cubeArray[x,y,z].setAlreadyClicked(true);
							newCube.transform.parent = MainController.instance.dragCube.transform;
						}
					}
				}
			}
			...
			MainController.instance.loseGame = true;
			
			//MainController.instance.endGame("lose");
		}
	}
	...
	//mines it's touching and change the selected cube accordingly
		...
		if (mineCounter == 1){
			var newCube1:Cube;
			newCube1 = Instantiate(MainController.instance.cube1, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
			...
			newCube1.transform.parent = MainController.instance.dragCube.transform;
			newCube1.setSelected(true);
			MainController.instance.unknownNum--;
			MainController.instance.unknownText.text = "Unknowns: " + MainController.instance.unknownNum;
		}
		//cube is touching 2 mines
		else if (mineCounter == 2){
			var newCube2:Cube;
			newCube2 = Instantiate(MainController.instance.cube2, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
			Destroy(cubeArray[foundX, foundY, foundZ].gameObject);
			cubeArray[foundX, foundY, foundZ] = newCube2;
			cubeArray[foundX, foundY, foundZ].setAlreadyClicked(true);
			newCube2.transform.parent = MainController.instance.dragCube.transform;
		...
		//cube is touching 3 mines
			...
			var newCube3:Cube;
			newCube3 = Instantiate(MainController.instance.cube3, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
			Destroy(cubeArray[foundX, foundY, foundZ].gameObject);
			cubeArray[foundX, foundY, foundZ] = newCube3;
			cubeArray[foundX, foundY, foundZ].setAlreadyClicked(true);
			newCube3.transform.parent = MainController.instance.dragCube.transform;
		...
		//cube is touching 4 mines
			...
			var newCube4:Cube;
			newCube4 = Instantiate(MainController.instance.cube4, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
			Destroy(cubeArray[foundX, foundY, foundZ].gameObject);
			cubeArray[foundX, foundY, foundZ] = newCube4;
			cubeArray[foundX, foundY, foundZ].setAlreadyClicked(true);
			newCube4.transform.parent = MainController.instance.dragCube.transform;
		...
		//cube is touching 5 mines
			...
			var newCube5:Cube;
			newCube5 = Instantiate(MainController.instance.cube5, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
			Destroy(cubeArray[foundX, foundY, foundZ].gameObject);
			cubeArray[foundX, foundY, foundZ] = newCube5;
			cubeArray[foundX, foundY, foundZ].setAlreadyClicked(true);
			newCube5.transform.parent = MainController.instance.dragCube.transform;
		...
		//cube is touching 6 mines
			...
			var newCube6:Cube;
			newCube6 = Instantiate(MainController.instance.cube6, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
			Destroy(cubeArray[foundX, foundY, foundZ].gameObject);
			cubeArray[foundX, foundY, foundZ] = newCube6;
			cubeArray[foundX, foundY, foundZ].setAlreadyClicked(true);
			newCube6.transform.parent = MainController.instance.dragCube.transform;
		...
		//aren't touching any mines to 0
			...
			//0 mines
			MainController.instance.checkForZeroCubes(currentX, currentY, currentZ);
			cubeArray[foundX, foundY, foundZ].setSelected(true);
		}
		
		//play sound when cube is selected
		if (MainController.instance.soundsOn){
			MainController.instance.transform.audio.PlayOneShot(MainController.instance.selectSound);
		}
		MainController.instance.updateGUI();
...
public static function flagTheCube(){
	...
	//cube, put a flag there
	else if ((cubeArray[foundX, foundY, foundZ].getID() == -1) && (MainController.instance.flagsLeft > 0)){
		var newFlag:Cube;
		newFlag = Instantiate(MainController.instance.flagCube, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
		...
		newFlag.transform.parent = MainController.instance.dragCube.transform;
		newFlag.setSelected(true);
		
		MainController.instance.flagsLeft--;
		if (MainController.instance.soundsOn){
			MainController.instance.transform.audio.PlayOneShot(MainController.instance.flagSound);
		}
		MainController.instance.flagText.text = "Flags: " + MainController.instance.flagsLeft;
	...
	//if cube already has a flag in it, remove the flag and make it a basic cube again
		...
		var newCube:Cube;
		newCube = Instantiate(MainController.instance.cube, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
	...
	if (MainController.instance.flagsLeft == 0){
		...
		if (mineCount == MainController.instance.totalMines){
			MainController.instance.winGame = true;
			//MainController.instance.mainText.enabled = false;
			//MainController.instance.mainText.SendMessage("showHint", "You Win!!");
		}
	}
	MainController.instance.updateGUI();
}
...
function checkForZeroCubes(foundX:int, foundY:int, foundZ:int){
	...
	if (mineCounter == 0){
		...
		var newCube0:Cube;
		newCube0 = Instantiate(MainController.instance.cube0, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
		Destroy(cubeArray[foundX, foundY, foundZ].gameObject);
		cubeArray[foundX, foundY, foundZ] = newCube0;
		cubeArray[foundX, foundY, foundZ].setAlreadyClicked(true);
		newCube0.transform.parent = MainController.instance.dragCube.transform;
...
public static function toggleMusic(){
	if (MainController.instance.musicOn){
		MainController.instance.musicOn = false;
		MainController.instance.audio.Pause();
		MainController.instance.musicGUI.texture = MainController.instance.musicOffTexture;
	}
	else {
		MainController.instance.musicOn = true;
		MainController.instance.audio.Play();
		MainController.instance.musicGUI.texture = MainController.instance.musicOnTexture;
	}
}

public static function toggleSounds(){
	if (MainController.instance.soundsOn){
		MainController.instance.soundsOn = false;
		MainController.instance.volumeGUI.texture = MainController.instance.volumeOffTexture;
	}
	else {
		MainController.instance.soundsOn = true;
		MainController.instance.volumeGUI.texture = MainController.instance.volumeOnTexture;
	}
}
...
public static function quitGame(){
	MainController.instance.quitGameStart();
}

public static function rotateTheCube() {
	
    MainController.instance.dragCube.transform.Rotate((Input.GetAxis("RotateZ") * -MainController.instance.rotationSpeed * Time.deltaTime), (Input.GetAxis("RotateX") * -MainController.instance.rotationSpeed * Time.deltaTime), 
    												(Input.GetAxis("RotateY") * MainController.instance.rotationSpeed * Time.deltaTime), Space.World);
}

public static function reorientTheCube() {
	
	MainController.instance.dragCube.transform.rotation = Quaternion.identity;
}