...
static var instance:MainController2;
...
var spacing:int = 3;
public static var xGrid:int = 6;
public static var yGrid:int = 6;
public static var zGrid:int = 6;
...
function OnGUI(){
 	...
 	//xSlider = GUI.HorizontalSlider(Rect(585,485,195,25),xSlider,0,5);
 	//zSlider = GUI.HorizontalSlider(Rect(585,721,195,25),zSlider,5,0);
 	//ySlider = GUI.VerticalSlider(Rect(565,50,25,195),ySlider,5,0);
	...
	if (winGame){
		...
		if (enteredName){
			...
			gameObject.Find("Database").GetComponent(HSControllerGame2).getScores();
			...
			if (databaseScores != ""){
				...
				if (mainTimer < scoreNum){
					...
					if (GUI.Button (Rect (Screen.width / 2 - 65, Screen.height / 2 + 25, 130, 30), "Submit")){
						gameObject.Find("Database").GetComponent(HSControllerGame2).postScore(winnerName, mainTimer, "intermediate");
						enteredName = true;
					}
				}
				else {
					...
					if (GUI.Button (Rect (Screen.width / 2 - 100, Screen.height / 2  + 40, 200, 25), "Main Menu")){
						...
						winGame = false;
						MainController2.instance.loseGameFunction();
					}
				} 
			}
		}
...
public static function fadeOut(){
	fadeDir = 1;
	MainController2.instance.fadeOutBool = true;
}
...
function createGUI(){
	...
	topGUIContainer.transform.position.x = Camera.main.transform.position.x + 20;
	topGUIContainer.transform.position.y = Camera.main.transform.position.y - 2;
	topGUIContainer.transform.position.z = Camera.main.transform.position.z + 5;
	...
	frontGUIContainer.transform.position.x = Camera.main.transform.position.x + 13.75;
	frontGUIContainer.transform.position.y = Camera.main.transform.position.y - 13.5;
	frontGUIContainer.transform.position.z = Camera.main.transform.position.z + 2;
	...
	rightGUIContainer.transform.position.x = Camera.main.transform.position.x + 8;
	rightGUIContainer.transform.position.y = Camera.main.transform.position.y - 25;
	rightGUIContainer.transform.position.z = Camera.main.transform.position.z - 1;
...
public static function changeSelection(xIn:int, yIn:int, zIn:int){
	...
	MainController2.instance.xSlider = currentX;
	MainController2.instance.ySlider = currentY;
	MainController2.instance.zSlider = currentZ;
	
	MainController2.instance.updateGUI();
}
...
public static function selectCube(){
	...
	//checks to see if selected cube contains a mine. If it does, lose the game
		...
		if (MainController2.instance.firstSelection){
			MainController2.instance.firstSelection = false;
		...
		//otherwise if it's not the first selection of the game
			...
			//MainController2.instance.mainText.enabled = false;
			//MainController2.instance.mainText.SendMessage("showHint", "You Lose!!");
			
			//play mine sound
			if (MainController2.instance.soundsOn){
				MainController2.instance.transform.audio.PlayOneShot(MainController2.instance.mineSound);
			}
				...
				for (y = 0; y < yGrid; y++){
					for (z = 0; z < zGrid; z++){
						if (cubeArray[x,y,z].getHasMine()){
							newCube = Instantiate(MainController2.instance.mineCube, cubeArray[x,y,z].transform.position, cubeArray[x,y,z].transform.rotation);
							Destroy(cubeArray[x,y,z].gameObject);
							cubeArray[x,y,z] = newCube;
							cubeArray[x,y,z].setAlreadyClicked(true);
							newCube.transform.parent = MainController2.instance.dragCube.transform;
						}
					}
				}
			}
			...
			MainController2.instance.loseGame = true;
			
			//MainController2.instance.endGame("lose");
		}
	}
	...
	//mines it's touching and change the selected cube accordingly
		...
		if (mineCounter == 1){
			var newCube1:Cube;
			newCube1 = Instantiate(MainController2.instance.cube1, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
			...
			newCube1.transform.parent = MainController2.instance.dragCube.transform;
			newCube1.setSelected(true);
			MainController2.instance.unknownNum--;
			MainController2.instance.unknownText.text = "Unknowns: " + MainController2.instance.unknownNum;
		}
		//cube is touching 2 mines
		else if (mineCounter == 2){
			var newCube2:Cube;
			newCube2 = Instantiate(MainController2.instance.cube2, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
			Destroy(cubeArray[foundX, foundY, foundZ].gameObject);
			cubeArray[foundX, foundY, foundZ] = newCube2;
			cubeArray[foundX, foundY, foundZ].setAlreadyClicked(true);
			newCube2.transform.parent = MainController2.instance.dragCube.transform;
		...
		//cube is touching 3 mines
			...
			var newCube3:Cube;
			newCube3 = Instantiate(MainController2.instance.cube3, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
			Destroy(cubeArray[foundX, foundY, foundZ].gameObject);
			cubeArray[foundX, foundY, foundZ] = newCube3;
			cubeArray[foundX, foundY, foundZ].setAlreadyClicked(true);
			newCube3.transform.parent = MainController2.instance.dragCube.transform;
			newCube3.setSelected(true);
		}
		//cube is touching 4 mines
		else if (mineCounter == 4){
			var newCube4:Cube;
			newCube4 = Instantiate(MainController2.instance.cube4, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
			Destroy(cubeArray[foundX, foundY, foundZ].gameObject);
			cubeArray[foundX, foundY, foundZ] = newCube4;
			cubeArray[foundX, foundY, foundZ].setAlreadyClicked(true);
			newCube4.transform.parent = MainController2.instance.dragCube.transform;
		...
		//cube is touching 5 mines
			...
			var newCube5:Cube;
			newCube5 = Instantiate(MainController2.instance.cube5, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
			Destroy(cubeArray[foundX, foundY, foundZ].gameObject);
			cubeArray[foundX, foundY, foundZ] = newCube5;
			cubeArray[foundX, foundY, foundZ].setAlreadyClicked(true);
			newCube5.transform.parent = MainController2.instance.dragCube.transform;
		...
		//cube is touching 6 mines
			...
			var newCube6:Cube;
			newCube6 = Instantiate(MainController2.instance.cube6, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
			Destroy(cubeArray[foundX, foundY, foundZ].gameObject);
			cubeArray[foundX, foundY, foundZ] = newCube6;
			cubeArray[foundX, foundY, foundZ].setAlreadyClicked(true);
			newCube6.transform.parent = MainController2.instance.dragCube.transform;
		...
		//aren't touching any mines to 0
			...
			//0 mines
			MainController2.instance.checkForZeroCubes(currentX, currentY, currentZ);
			cubeArray[foundX, foundY, foundZ].setSelected(true);
		}
		
		//play sound when cube is selected
		if (MainController2.instance.soundsOn){
			MainController2.instance.transform.audio.PlayOneShot(MainController2.instance.selectSound);
		}
		MainController2.instance.updateGUI();
...
public static function flagTheCube(){
	...
	//cube, put a flag there
	else if ((cubeArray[foundX, foundY, foundZ].getID() == -1) && (MainController2.instance.flagsLeft > 0)){
		var newFlag:Cube;
		newFlag = Instantiate(MainController2.instance.flagCube, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
		...
		newFlag.transform.parent = MainController2.instance.dragCube.transform;
		newFlag.setSelected(true);
		
		MainController2.instance.flagsLeft--;
		if (MainController2.instance.soundsOn){
			MainController2.instance.transform.audio.PlayOneShot(MainController2.instance.flagSound);
		}
		MainController2.instance.flagText.text = "Flags: " + MainController2.instance.flagsLeft;
	...
	//if cube already has a flag in it, remove the flag and make it a basic cube again
		...
		var newCube:Cube;
		newCube = Instantiate(MainController2.instance.cube, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
	...
	if (MainController2.instance.flagsLeft == 0){
		...
		if (mineCount == MainController2.instance.totalMines){
			MainController2.instance.winGame = true;
			//MainController2.instance.mainText.enabled = false;
			//MainController2.instance.mainText.SendMessage("showHint", "You Win!!");
		}
	}
	MainController2.instance.updateGUI();
}
...
function checkForZeroCubes(foundX:int, foundY:int, foundZ:int){
	...
	if (mineCounter == 0){
		...
		var newCube0:Cube;
		newCube0 = Instantiate(MainController2.instance.cube0, cubeArray[foundX, foundY, foundZ].transform.position, cubeArray[foundX, foundY, foundZ].transform.rotation);
		Destroy(cubeArray[foundX, foundY, foundZ].gameObject);
		cubeArray[foundX, foundY, foundZ] = newCube0;
		cubeArray[foundX, foundY, foundZ].setAlreadyClicked(true);
		newCube0.transform.parent = MainController2.instance.dragCube.transform;
...
public static function toggleMusic(){
	if (MainController2.instance.musicOn){
		MainController2.instance.musicOn = false;
		MainController2.instance.audio.Pause();
		MainController2.instance.musicGUI.texture = MainController2.instance.musicOffTexture;
	}
	else {
		MainController2.instance.musicOn = true;
		MainController2.instance.audio.Play();
		MainController2.instance.musicGUI.texture = MainController2.instance.musicOnTexture;
	}
}

public static function toggleSounds(){
	if (MainController2.instance.soundsOn){
		MainController2.instance.soundsOn = false;
		MainController2.instance.volumeGUI.texture = MainController2.instance.volumeOffTexture;
	}
	else {
		MainController2.instance.soundsOn = true;
		MainController2.instance.volumeGUI.texture = MainController2.instance.volumeOnTexture;
	}
}
...
public static function quitGame(){
	MainController2.instance.quitGameStart();
}

public static function rotateTheCube() {
	
    MainController2.instance.dragCube.transform.Rotate((Input.GetAxis("RotateZ") * -MainController2.instance.rotationSpeed * Time.deltaTime), (Input.GetAxis("RotateX") * -MainController2.instance.rotationSpeed * Time.deltaTime), 
    												(Input.GetAxis("RotateY") * MainController2.instance.rotationSpeed * Time.deltaTime), Space.World);
}

public static function reorientTheCube() {
	
	MainController2.instance.dragCube.transform.rotation = Quaternion.identity;
}